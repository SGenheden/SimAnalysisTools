...
class SoluteGyrationAnalysis(TrajectoryAction):
    """
    ...
    @staticmethod
    def descr() :
        return "Analyze the radius of gyration for a selection"
...
class SoluteOrientationAnalysis(TrajectoryAction):
    """
    ...
    @staticmethod
    def descr() :
        return "Analyze thr orientation of a solute "
...
class StripAtoms(TrajectoryAction) :
    @staticmethod
    def descr() :
        return "Strip atoms from a trajectory"
...
class VectorPlaneAngleAnalysis(TrajectoryAction):
    ...
    @staticmethod
    def descr() :
        return "Analyze the angle between a vector and a plane"
